...
// Update is released on 2026-08-24; test opens on 2026-08-26.
app.get('/api/test-availability',(req,res)=>{
  const now=Date.now();
  const release=new Date('2026-08-24T00:00:00+02:00').getTime();
  const open=new Date('2026-08-26T00:00:00+02:00').getTime();
  res.json({
    released: now>=release,
    open: now>=open,
    releaseAt:'2026-08-24T00:00:00+02:00',
    openAt:'2026-08-26T00:00:00+02:00'
  });
});
